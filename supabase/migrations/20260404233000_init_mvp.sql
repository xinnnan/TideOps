...
create table public.safety_checkins (
  id uuid primary key default gen_random_uuid(),
  record_number bigint generated by default as identity (start with 100001),
...
create table public.daily_reports (
  id uuid primary key default gen_random_uuid(),
  record_number bigint generated by default as identity (start with 200001),
  client_id uuid not null references public.clients(id),
  site_id uuid not null references public.sites(id),
  project_id uuid not null references public.projects(id),
  render_company_id uuid not null references public.companies(id),
...
create table public.incidents (
  id uuid primary key default gen_random_uuid(),
  record_number bigint generated by default as identity (start with 300001),
  client_id uuid not null references public.clients(id),
  site_id uuid not null references public.sites(id),
  project_id uuid not null references public.projects(id),
  render_company_id uuid not null references public.companies(id),
...
create index idx_safety_checkins_record_number on public.safety_checkins(record_number desc);
create index idx_daily_reports_record_number on public.daily_reports(record_number desc);
create index idx_incidents_record_number on public.incidents(record_number desc);
